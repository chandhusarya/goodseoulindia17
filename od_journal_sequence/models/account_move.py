...
from odoo.tools import float_compare, date_utils, email_split, email_re, mute_logger
...
class SequenceMixin(models.AbstractModel):
    ...
    def _set_next_sequence(self):
        ...
        if new:
            if not last_sequence and format_values['year'] != self[self._sequence_date_field].year:
                format_values['seq'] = 0
